...
module.exports = { session: process.env.SESSION_ID || 'keith',
    ...
    GITHUB : process.env.GITHUB|| 'https://github.com/Lupin-lion/LUPIN-MD',
    ...
    AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || 'viewed by lupin md',   
    AUTO_STATUS_REPLY: process.env.AUTO_STATUS_REPLY || 'no',
    AUTOBIO: process.env.AUTOBIO || 'yes',       
    ANTICALL_MSG : process.env.ANTICALL_MESSAGE || '',             
    GURL: process.env.GURL  || "https://chat.whatsapp.com/EIV9hfCuVed64PwCc5ha2O",
    EVENTS :process.env.EVENTS || "yes",
    CAPTION : process.env.CAPTION || "LUPIN-MD",
    BOT : process.env.BOT_NAME || 'LUPIN_MD',
